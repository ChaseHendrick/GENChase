...
On 2026-09-24 grains is recorded as **partially validated**. The review argued for validated within
stated limits, but two criteria fixed before the run were missed: production-step restitution
(−10.6% against a 10% bound) and incline slip at tan θ/3μ = 1.05 (+8.67% against 3%). A label
does not round toward the claim, so the evidence below supports a partial label for:
