...
(function () {
  ...
  Studio.register({
    id: 'fluid', name: 'Fluid', subtitle: 'Navier-Stokes dye advected by a stable-fluids solver · 1999', equation: 'du/dt + (u·grad)u = -grad p + nu·lap u,   div u = 0   (advect -> project -> advect dye)', credit: "Stable fluids: Jos Stam, SIGGRAPH 1999. Vorticity confinement comes from Steinhoff and Underhill, 1994, brought into graphics by Fedkiw, Stam and Jensen, 2001.", order: 60,
    blurb: 'An incompressible fluid obeys the Navier-Stokes equations: velocity is carried along by itself, diffused, pushed by forces, and constrained so that no cell gains or loses volume. Jos Stam\'s 1999 "stable fluids" method makes this tractable on a grid — each step traces every cell backwards along the flow to fetch its new velocity (semi-Lagrangian advection, unconditionally stable), then solves a Poisson equation for pressure and subtracts its gradient to remove divergence. A passive dye field is advected by the same velocities at higher resolution; vorticity confinement re-injects the small swirls that the grid smooths away.',
