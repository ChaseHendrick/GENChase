...
(function () {
  ...
  // arrows from the start cell walks the loop-erased path and nothing else. Under independent uniform random choices, every spanning tree of the
  // graph has equal probability. The implementation uses a finite seeded PRNG; numerical
  // sampling tests do not prove literal uniformity across all possible seed strings.
