...
with zipfile.ZipFile(sys.argv[1]) as z:
 ...
 await page.setViewportSize({width:1280,height:900});await page.getByRole('link',{name:'Make art now',exact:true}).click();await page.evaluate(()=>Studio.ready);await page.waitForFunction(()=>Studio.getRecipe()?.technique==='tilings'||Studio.getRecipe()?.id==='tilings');
