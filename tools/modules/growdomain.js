  ...
  Studio.register({
    ...
    create(host) {
      ...
      function measure() {
        ...
        // 4.20 ± 0.13 at 0.04, against a peak of 4.87. Three further seeds put the same ladder within
        // about four tenths at every rung and none of them reaches the peak. That is the quasi-static
        // limit arriving, and it is why the middle of the tooth is the quantity compared with the peak
        // rather than either end of it. The rate slider will not go below about 0.04 at this grid and growth, because a
