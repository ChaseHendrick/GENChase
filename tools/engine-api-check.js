...
(async()=>{
 ...
 const result=await page.evaluate(async()=>{
  ...
  check(Studio.apiVersion===1&&Studio.recipeVersion===3,'versions');
  ...
  const recipe=Studio.getRecipe();check(recipe.v===3&&recipe.seed==='api-baseline','versioned recipe');recipe.seed='mutated';check(Studio.getRecipe().seed==='api-baseline','recipe clone');
