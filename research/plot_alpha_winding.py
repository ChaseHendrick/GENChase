#!/usr/bin/env python3
"""Figure for research/alpha-winding-2026-09-24.typ.
...
Writes research/figures/alpha-winding.svg (Typst) and alpha-winding.pdf (LaTeX). Seeded; runs in a few seconds.
"""
...
fig.tight_layout()
out = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'figures', 'alpha-winding.svg')
