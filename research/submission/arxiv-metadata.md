...
- **Comments:** `13 pages, 1 figure, 1 table. Verification programs and data: https://github.com/SharpMeow/GENChase/tree/main/research`
  - The page count is for the LaTeX build. For the PDF-only route with the Typst PDF, write 13 pages.
