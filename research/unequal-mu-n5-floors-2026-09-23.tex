...
\begin{proof}
The harmonic condition and the vanishing of the angular impulse are the classical necessary conditions \cite[Sect.~II~B]{aref2010} (see also \cite[Sect.~3]{bl1998}); we include the short argument. Along the motion
\[
...
Every collapse of three point vortices in the plane is self-similar \cite[Theorem~1.1]{drivas2026}, \cite{ks2018}, so the bound of Corollary~\ref{cor:bound} holds for every collapse of three point vortices.
