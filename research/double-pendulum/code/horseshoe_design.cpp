...
//
// usage: horseshoe_design E p_t2 p_p2 vu_x vu_y vs_x vs_y x_lo x_hi k J a1 b [cfac] [bmin] > out.cfg
...
int main(int argc, char** argv) {
  ...
  for (int i = 0; i <= L; ++i) {
    ...
    beta = std::max(3 * std::max(ym, my), bmin);   // never below the width of a validated one-return enclosure
