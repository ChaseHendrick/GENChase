...
$|\nabla_\zeta G(\xi,0)|\le 2.811|\xi|^3$ (same method); and, on a box containing the domain with
$|\zeta|\le 2\cdot10^{-3}$, $\lambda_{\min}(C^T\nabla^2F\,C)\ge\mu=0.0664$ (third-derivative enclosure and
Weyl's inequality). Taylor's theorem in $\zeta$ and $2.811\,X^3Y\le\frac{\mu}{4}Y^2+\frac{2.811^2}{\mu}X^6$ give
\[
