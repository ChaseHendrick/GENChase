"""Checks for the preprint research/alpha-winding-2026-09-24.typ (winding of self-similar three-vortex collapse
in the alpha-models). Run from the repository root: python3 research/verify_alpha_winding.py
