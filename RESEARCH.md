...
- **Bibliography.** Grotto-Romito-Viviani now cited in its journal version (Physica D 457 (2024) 133947; the manuscript's one-sentence description is of the abstract, which the journal version shares in substance, not re-read); Conte-de Seze's Mod. Phys. Lett. B 29 (2015) 1530017 added; Borisov-Lebedev pp. 74-86 (two search results, not the journal page); Hernandez-Garduno-Lacomba marked as arXiv theorem numbering.
