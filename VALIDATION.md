...
> 79 unvalidated; 9 partially validated; 42 validated within stated limits.
...
| [ssh](src/modules/ssh.js) | validated within stated limits | [ssh-science.js](tools/ssh-science.js), [ssh-production.js](tools/ssh-production.js) | Limited evidence recorded |
...
| [tennis](src/modules/tennis.js) | validated within stated limits | [rigid-body-audit.js](tools/rigid-body-audit.js) | Limited evidence recorded |
...
- Catalog equation and citation are review targets, not verified paper equivalence.
- Complete evidence covers only the documented domain in validation/SSH.md and the ssh-science / ssh-production / ssh-print-state results artifacts.
- Finite single-particle chains; no interactions, disorder, continuum limit or experimental polyacetylene claim. Rows inside exactly degenerate clusters follow a documented basis convention.
- Broader settings require additional independent evidence.
