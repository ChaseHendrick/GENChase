...
> 79 unvalidated; 12 partially validated; 39 validated within stated limits.
...
| [veselago](src/modules/veselago.js) | partially validated | [veselago-science.js](tools/veselago-science.js) | Limited evidence recorded |
...
- The status label is not validated and is wrong over part of the slider domain. It reads "Veselago focus" whenever \|Δx\|/W < 0.12 (veselago.js:132): in 11,829 of the 16,468 in-domain sweep configurations where no ray crosses the axis behind the slab, including n = −2.20 to −2.00 at the default slab, and at n = +1. This defect blocks full validation.
- When the back face lies beyond the last drawn column (grid 128 or 144 with a thick slab and a distant source), the exit segment is drawn backwards from the back face to W − 2 (veselago.js:79–82). That inks cells no ray reaches: 1,767 of 2,368 such sweep configurations, 24,214 stray cells. These plates are outside the domain, and the defect blocks full validation.
- Transmitted geometric rays only: no Fresnel reflection, wave optics, evanescent-wave amplification (Pendry), absorption or dispersion. At n = −0.40, rays with \|sin θ\| > 0.4 have no transmitted ray and are skipped entirely at veselago.js:74, incident segment included, with nothing on the plate or status line to say so: 2 of 12, 4 of 28, 6 of 48 and 6 of 64 rays.
...
- Hash-only indices between −0.43497 and −0.4 reach the 0.05 slope clamp (veselago.js:83) for near-grazing rays: 322.85 px vertex error at n = −0.43527. These indices are outside the domain.
