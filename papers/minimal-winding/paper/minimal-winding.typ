...
Every collapse of three point vortices in the plane is self-similar [8, Theorem 1.1], [9, Prop. 5.2], [18], and every motion of three vortices that ends in a total collision is self-similar [13, Theorem 1], [14, Sect. 3], so the bound of Corollary 1 holds for every collapse of three point vortices. The bound does not carry over to larger systems: the collapsing configuration of seven vortices in [7, Table 1, Fig. 1a] has the constant $Omega = 12433\/9000 - (31 sqrt(155)\/450) i$, where $Omega = 2 pi i overline(kappa)$ [7, Eq. (11)], so $P = |op("Re") Omega| \/ (2 |op("Im") Omega|) = 12433\/(1240 sqrt(155)) = 0.8053 dots < sqrt(3)\/2$.
