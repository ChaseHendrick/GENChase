...
Every collapse of three point vortices in the plane is self-similar [8, Theorem 1.1], [9, Prop. 5.2], [19, Sect. 3.1], and every motion of three vortices that ends in a total collision is self-similar [13, Theorem 1], [14, Prop. 2.8], [15, Sect. 3], so the bound of Corollary 1 holds for every collapse of three point vortices. The bound does not carry over to larger systems: the collapsing configuration of seven vortices in [7, Table 1, Fig. 1a] has the constant $Omega = 12433\/9000 - (31 sqrt(155)\/450) i$, where $Omega = 2 pi i overline(kappa)$ [7, Eq. (11)], so $P = |op("Re") Omega| \/ (2 |op("Im") Omega|) = 12433\/(1240 sqrt(155)) = 0.8053 dots < sqrt(3)\/2$.
...
For $n = 2$ the configuration is a parallelogram of four vortices; four-vortex collapse is treated by Novikov and Sedov [22, Sect. 4]. The ratio $x_n$ is rational exactly when $2n - 1$ is a perfect square, and $n = 5$ is the smallest such $n$. There $x_5 = 2$ and
