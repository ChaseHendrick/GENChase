...
\medskip
\noindent\textbf{Data availability.} The programs \texttt{verify\_general\_mu.py}, \texttt{verify\_floors\_independent.py} and \texttt{plot\_minimal\_winding.py}, used for Section~\ref{sec:numerics} and Figure~\ref{fig:minima}, and their output are in the repository \url{https://github.com/SharpMeow/minimal-winding}, the programs in \texttt{code/} and their output in \texttt{data/}.
