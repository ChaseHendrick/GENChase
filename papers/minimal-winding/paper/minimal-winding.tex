...
\medskip
\noindent\textbf{Data availability.} The programs \texttt{verify\_general\_mu.py}, \texttt{verify\_floors\_independent.py} and \texttt{plot\_minimal\_winding.py}, used for Section~\ref{sec:numerics} and Figure~\ref{fig:minima}, and their output are in the repository \url{https://github.com/ChaseHendrick/minimal-winding}, the programs in \texttt{code/} and their output in \texttt{data/}.
...
\bibitem{cds1980} R. Conte and L. de Seze, Exact solution of the planar motion of three arbitrary point vortices, report DPhG/PSRM/1697/80, CEN Saclay (1980); arXiv:1511.00069v1, whose page numbers are cited.
