...
\medskip
\noindent\textbf{Data availability.} The programs \texttt{verify\_general\_mu.py}, \texttt{verify\_floors\_independent.py} and \texttt{plot\_minimal\_winding.py}, used for Section~\ref{sec:numerics} and Figure~\ref{fig:minima}, and their output are in the repository \url{https://github.com/ChaseHendrick/minimal-winding}: the programs in \texttt{code/}, the output of the two verification programs in \texttt{data/}, and the figure in \texttt{paper/figures/}.
