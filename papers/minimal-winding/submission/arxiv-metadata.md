...
- **Comments:** `33 pages, 3 figures, 2 tables. Includes computer-assisted proofs in interval arithmetic. Verification programs and data: https://github.com/ChaseHendrick/minimal-winding`
