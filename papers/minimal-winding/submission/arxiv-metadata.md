...
- **Comments:** `32 pages, 3 figures, 2 tables. Includes computer-assisted proofs in interval arithmetic. Verification programs and data: https://github.com/ChaseHendrick/minimal-winding`
...
## Abstract (plain text with TeX math, 1,872 characters; the limit is 1,920)
