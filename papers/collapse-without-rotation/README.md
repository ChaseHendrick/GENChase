...
| [`verify_sharpness_all_n.py`](code/verify_sharpness_all_n.py) | Lemma 1 and Corollary 3: the pair and the triangle exactly (translation, nondegeneracy, the zeros of R, discriminant -216); clusters of 5 to 13 vortices grown by the induction (binary64) and their collapse families at forty digits, checked against the Biot-Savart equations of all vortices; controls | 25 | 10 s |
