...
_BETA = fmpq(20)        # gain of the logistic (Faye 2013 and Hastings 2017 use lambda = 20)
_THETA = fmpq(1, 4)     # threshold (Pinto-Ermentrout Figs. 1c and 8 use theta = .25)
_EPS = fmpq(1, 10)      # recovery rate (fixed, not asymptotically small)
_GAMMA = fmpq(0)        # Pinto-Ermentrout Sect. 3.1 and Fig. 8 take the feedback decay beta = 0
