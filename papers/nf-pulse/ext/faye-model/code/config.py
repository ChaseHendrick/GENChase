...
theta0    : manifold parameter of the start point;  nman: manifold order;  T_enter: time of the block check.
"""
import os
...
CONFIG = {
    '1/20': {
        ...
        'prec': 256, 'order': 30, 'tol': 1e-45, 'theta0': '1/2', 'nman': 80, 'T_enter': 12.5,
    },
    '1/50': {
        # c* = 0.3123155710060636100917070892169975669710796364876456984859455160599777313499758551329556775... (shoot_ms.py)
        'c1': '0.31231557100606361009170708921699756697107963648764569848594551605997773134997585513295567751',
        'c2': '0.31231557100606361009170708921699756697107963648764569848594551605997773134997585513295567752', 'side_c1': -1, 'side_c2': +1,
        'c_far': '0.3123',
        'block': {'c_ref': 0.3123156, 'a_ref': 0.307321, 's_ref': 0.0172063, 'd': [105.977, 7.84445, 96.502, 48.5248], 'r_over_rho': 1.0001},
        'prec': 480, 'order': 60, 'tol': 1e-110, 'theta0': '1/4', 'nman': 120, 'T_enter': 30.0,
    },
    '1/100': {
        # Faye's value.  c* = 0.3315163... (floating-point shooting; bracket to be computed)
        'c1': '0.3315163', 'c2': '0.3315164', 'side_c1': -1, 'side_c2': +1,
        'c_far': '0.3315',
        'block': {'c_ref': 0.3315163, 'a_ref': 0.301217, 's_ref': 0.0167288, 'd': [186.698, 12.2472, 148.731, 64.0335], 'r_over_rho': 1.04785},
        'prec': 800, 'order': 100, 'tol': 1e-200, 'theta0': '1/8', 'nman': 200, 'T_enter': 72.0,
    },
}
