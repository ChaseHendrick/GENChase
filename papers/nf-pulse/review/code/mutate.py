...
#
#     python3 papers/nf-pulse/review/code/mutate.py <scratch_dir> [mutation_id ...]
#
...
# runs review/code/lohner_stress.py (a low-order integrator test against mpmath, not part of run_all.sh)
...
def stress(scratch, want):
    ...
    txt = 'nf-pulse integrator mutations against review/code/lohner_stress.py\n\n' + '\n'.join(rows) + '\n'
...
def main():
    ...
    lines = ['nf-pulse mutation results (run_all.sh, 15 checks), generated by review/code/mutate.py', '']
